...
const OtherInformation = () => {
  ...
  const fetchInformation = async () => {
    try {
      const res = await axios.get(`${API_BASE_URL}/OtherInfo/other-information`, getAuthHeaders());
      setData(res.data);
  ...
  const handleAdd = async () => {
    ...
    setLoading(true);
    try {
      await axios.post(`${API_BASE_URL}/OtherInfo/other-information`, newInformation, getAuthHeaders());
      setNewInformation({
        specialSkills: '',
        nonAcademicDistinctions: '',
        membershipInAssociation: '',
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}/OtherInfo/other-information/${id}`, getAuthHeaders());
      setEditInformation(null);
      setOriginalInformation(null);
      setSelectedEditEmployee(null);
      setIsEditing(false);
  ...
  const handleEditEmployeeChange = (employeeNumber) => {
    setEditInformation({ ...editInformation, person_id: employeeNumber });
  };
  ...
  const handleOpenModal = async (information) => {
    ...
    setSelectedEditEmployee({
      name: employeeName,
      employeeNumber: information.person_id,
    });
    setIsEditing(false);
  };
  ...
  const handleCancelEdit = () => {
    ...
    setSelectedEditEmployee({
      name: employeeNames[originalInformation.person_id] || 'Unknown',
      employeeNumber: originalInformation.person_id,
    });
    setIsEditing(false);
  };
  ...
  const hasChanges = () => {
    ...
    return (
      ...
      editInformation.membershipInAssociation !== originalInformation.membershipInAssociation ||
      editInformation.person_id !== originalInformation.person_id
    );
  };
              ...
              >
                ...
                <Box display="flex" alignItems="center" justifyContent="space-between" position="relative" zIndex={1}>
                  <Box display="flex" alignItems="center">
                    ...
                    >
                      <InfoIcon sx={{color: accentColor, fontSize: 32 }} />
                    </Avatar>
                    <Box>
        ...
        >
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="h6" sx={{ mt: 2, color: primaryColor }}>
              Processing other information record...
            </Typography>
          </Box>
        </Backdrop>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" sx={{ opacity: 0.9 }}>
                      Fill in the other information details
                    </Typography>
                  </Box>
                </Box>
                ...
                <Box sx={{ 
                  ...
                  <Box sx={{ mb: 3 }}>
                    <ModernTextField
                      size="small"
                      variant="outlined"
                      placeholder="Search by Employee ID, Name, or Skills"
                      value={searchTerm}
                            ...
                            >
                              <CardContent sx={{ p: 2, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                  <InfoIcon sx={{ fontSize: 18, color: accentColor, mr: 0.5 }} />
                          ...
                          <Box sx={{ p: 2 }}>
                            <Box sx={{ display: 'flex', alignItems: 'flex-start' }}>
                              <Box sx={{ mr: 1.5, mt: 0.2 }}>
                                <InfoIcon sx={{ fontSize: 20, color: accentColor }} />
                              </Box>
